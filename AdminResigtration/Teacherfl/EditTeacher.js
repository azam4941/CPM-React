...
export class EditTeacherModel extends Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit(event) {
        ...
        axios.put("http://localhost:58526/api/TeacherMsts/" + event.target.ID.value, content, config)
            .then(responce => {
                console.log(responce)
            })
            .catch(error => {
                                ...
                                <Form onSubmit={this.handleSubmit}>
                                    ...
                                    <Form.Group controlId="RegNo">
                                        ...
                                        <Form.Control
                                            ...
                                            name="RegNo"
                                            required
                                            defaultValue={this.props.RegNo}
                                            placeholder="Teacher Register Number"
                                        />
                                    </Form.Group>
                                    ...
                                    <Form.Group controlId="Qualification">
                                        ...
                                        <Form.Control
                                            ...
                                            name="Qualification"
                                            required
                                            defaultValue={this.props.Qualification}
